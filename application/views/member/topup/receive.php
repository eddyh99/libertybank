                        ...
                        <div class="col-12 recive-bank  d-flex align-items-center flex-column text-center">
                            ...
                            if (
                                ...
                                if ($_SESSION["currency"] == "EUR") {?>
                                    ...
                                    <a href="<?= base_url() ?>receive/localbank" class="col-8 py-3 my-2 f-hahmlet">
                                        National SEPA Circuit
                                    </a>
                                ...
                                if (($_SESSION["currency"] == "USD") ||
                                    ...
                                    if ($_SESSION["currency"] == "EUR") {?>
                                        ...
                                        <a href="<?= base_url() ?>receive/interbank" class="col-8 py-3 my-2 f-hahmlet">
                                            International BIC/Swift
                                        </a>
                                ...
                                <a href="<?= base_url() ?>receive/interbank?currency=USD" class="col-8 py-3 my-2 f-hahmlet">
                                    USD International
                                </a>

                                <a href="<?= base_url() ?>receive/interbank?currency=EUR" class="col-8 py-3 my-2 f-hahmlet">
                                    EUR International
                                </a>
